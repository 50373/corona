...
namespace Project.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Patientid,Patientname,Departmentid,Doctorid,Doctorname")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Patientid,Patientname,Departmentid,Doctorid,Doctorname")] Appointment appointment)
        {
